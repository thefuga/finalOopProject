/**
 * Ranged.
 * This is class of ranged players. It may have different attacks from other 
 * classes.
...
public class Ranged extends Player{
    ...
    private static final int RANGED_SPECIAL_ATTACK_COOLDOWN = 4;
    ...
    public int specialAttack(){
        if(getSpecialAttackCooldown() == 0){
            setSpecialAttackCooldown(RANGED_SPECIAL_ATTACK_COOLDOWN);
